...
gulp.task('copy-csv', ['clean:dev', 'clean:dist'], function(){
  return gulp.src('app/graffiti-summary.csv')
    .pipe(gulp.dest('dev'))
    .pipe(gulp.dest('dist'));
});

gulp.task('copy-bootswatch', ['clean:dev', 'clean:dist'], function(){
  return gulp.src('app/assets/styles/bw-superhero-bootstrap.css')
    .pipe(gulp.dest('dev'))
    .pipe(gulp.dest('dist'));
});

//Compiles SASS to dev/styles.css and dist/styles.css
gulp.task('styles', ['clean:dev', 'clean:dist'], function () {
...
gulp.task('js', ['clean:dev', 'clean:dist'], function () {
  	return gulp.src('app/graffiti.js')
	    .pipe(jshint())
...
gulp.task('inject:dev', ['fonts', 'favicon', 'images', 'copy-indexes','copy-csv','copy-bootswatch', 'styles', 'js'], function(){
...
gulp.task('inject:dist', [ 'fonts', 'favicon', 'images','copy-indexes','copy-csv','copy-bootswatch', 'styles', 'js'], function(){
